...
router.use((0, auth_middleware_1.authorize)(user_model_1.UserRole.MANAGER, user_model_1.UserRole.LANDLORD));
router.get('/properties', manager_controller_1.getManagedProperties);
router.get('/tenants', manager_controller_1.getManagedTenants);
router.get('/tenants/:id', manager_controller_1.getTenantDetails);
