...
router.route('/')
    ...
    .post((0, auth_middleware_1.authorize)(user_model_1.UserRole.MANAGER), cloudinary_1.expenseUpload.single('document'), validation_middleware_1.validateCreateExpense, expense_controller_1.createExpense);
router.route('/:id')
...
router.put('/:id/reject', (0, auth_middleware_1.authorize)(user_model_1.UserRole.LANDLORD), validation_middleware_1.validateExpenseRejection, expense_controller_1.rejectExpense);
